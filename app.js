                ...
                ({ coords: { latitude, longitude } }) => {
                    fetch(`https://nominatim.openstreetmap.org/reverse?format=json&lat=${latitude}&lon=${longitude}&addressdetails=1`)
                        ...
                        .catch((error) => {
                            ...
                            document.getElementById('cityName').innerText = "Unable to fetch location";
                        });
                },
                () => {
    ...
    const container = document.getElementById('divRow');
        ...
        window.addEventListener('load', function() {
            ...
            storedDivs.forEach(storedData => {
                addNewDiv(storedData.city, storedData.index);
                updateDivWithWeatherData(storedData, storedData.index); // Restore weather data
            });
        });
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                <div class="text-white d-flex flex-column align-items-center justify-content-center">
                                    ...
                                    <img id="iconCity${index}" src="" alt="icon">
                                </div>
                            </div>
                            <div class="col-12 mb-3">
        ...
        if (data.forecast && data.forecast.forecastday.length > 0) {
            ...
            for (let i = 0; i < 5; i++) {
                ...
                if (i < numDays) {
                    ...
                    document.getElementById('more' + index).innerText = `Wind: ${wind} mph, Humidity: ${humidity}%`;
                } else {
                    ...
                    document.getElementById('more' + index).innerText = "Wind: -- mph, Humidity: --%";
                }
            }
        } else {
